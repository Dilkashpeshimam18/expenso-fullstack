...
export const getExpenseData = () => {
    return async (dispatch, state) => {
        const getRequest = async () => {
            ...
            const response = await reqInstance.get('http://13.50.152.75:4000/expense/get-expense')
...
export const postExpenseData = (expense) => {
    return async (state, dispatch) => {
        ...
        const postRequest = async () => {
            ...
            const response = await reqInstance.post('http://13.50.152.75:4000/expense/add-expense', expense)
            const data = {
                expense: Number(expense.amount),
                month: month
            }
            await reqInstance.post('http://13.50.152.75:4000/expense/add-yealyexpense', data)
...
export const updateExpenseData = (data) => {
    return async () => {
        ...
        const putRequest = async () => {
            ...
            const response = await reqInstance.put(`http://13.50.152.75:4000/expense/update-expense/${data.id}`, data.expense)
        }
...
export const deleteExpenseData = (id) => {
    return async () => {
        const deleteRequest = async () => {
            ...
            const response = await reqInstance.delete(`http://13.50.152.75:4000/expense/delete-expense/${id}`)
